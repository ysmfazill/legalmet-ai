...
const PATHS: Record<IconName, JSX.Element> = {
  ...
  complaints: (
    <>
      <path d="M21 11.5a8.4 8.4 0 0 1-9 8.4 8.6 8.6 0 0 1-3.7-.8L3 21l1.9-5.2a8.3 8.3 0 0 1-.9-3.8 8.4 8.4 0 0 1 8.5-8.4h.5a8.4 8.4 0 0 1 8 8.3v.6Z" />
  ...
  department: (
    <>
      ...
      <path d="M9 21v-4h6v4M9 10h.01M12 10h.01M15 10h.01M9 13h.01M12 13h.01M15 13h.01" />
    </>
  ),
